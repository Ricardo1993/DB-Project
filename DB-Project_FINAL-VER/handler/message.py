...
class MessageHandler:
     ...
     def mapToDict(self, row):
        ...
        # result['users_id'] = row[1]
        result['message_text'] = row[1]
        result['message_date'] = row[2]
        # result['user_first_name'] = row[4]
        # result['user_last_name'] = row[5]
     ...
     def mapToDict3(self, row):
        result = {}
        result['day'] = row[0]
        result['number_of_messages'] = row[1]
        # result['message_text'] = row[2]
        # result['message_date'] = row[3]
        # result['user_first_name'] = row[5]
        # result['user_last_name'] = row[6]
        # result['likes'] = row[5]
        # result['dislikes'] = row[6]
